...
#define LV_FONT_SIMSUN_16_CJK            0  /*disabled: SimSun is proprietary - replaced by Source Han Sans (OFL)*/
#define LV_FONT_SOURCE_HAN_16_CJK        1  /*CJK fallback regenerated from Source Han Sans SC (SIL OFL 1.1)*/
