...
/* receive music (receive_ui.c) - the server lives only while this screen is shown */
void receive_create(lv_obj_t *root);
void receive_ui_enter(void);
void receive_ui_leave(void);
/* wallpaper picker (wallpick.c) */
