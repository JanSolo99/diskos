...
static void rebuild(const char *q){
    ...
    for(int i=0;i<shown;i++){
        ...
        lv_obj_set_style_bg_color(row, th_card(), LV_STATE_PRESSED);
    ...
    if(n > MAX_RESULTS){    /* genuinely truncated - tell the user to narrow down */
        ...
        lv_obj_set_style_text_color(f, th_text3(), 0);
        lv_obj_set_style_text_font(f, th_font(14), 0);
    }
}
...
void search_create(lv_obj_t *root){
    ...
    lv_obj_set_style_text_color(bi, th_text2(), 0);
    ...
    lv_obj_set_style_bg_color(bar, th_card(), 0);
    ...
    lv_obj_set_style_text_font(g_bar_lbl, th_font(14), 0);
    lv_obj_set_style_text_color(g_bar_lbl, th_text3(), 0);
    ...
    lv_obj_set_style_bg_color(g_clear, th_card_press(), LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_color(ci, th_text2(), 0);
    lv_obj_center(ci);
